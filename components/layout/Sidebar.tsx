...
import {
    ...
    ChevronLeft, ChevronRight, Menu, X, LogOut, PlusCircle, BarChart3, TrendingUp, ClipboardCheck, GraduationCap, ClipboardList, Bell, Shield, FileStack, Library, KeyRound, Baby, Utensils, BookOpen, Settings, LifeBuoy
} from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onNavigate, onLogout, userName, userEmail, isAdmin, userRole, notificationCount = 0 }) => {
    ...
    const managementNavItems = [
        ...
        { icon: LifeBuoy, label: 'Suporte Técnico', view: 'SUPORTE_TECNICO' as ViewState },
