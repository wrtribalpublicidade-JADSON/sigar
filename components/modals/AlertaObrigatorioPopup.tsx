...
export const AlertaObrigatorioPopup: React.FC<AlertaObrigatorioPopupProps> = ({
  ...
  return (
    <>
        ...
        <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden animate-scale-in border border-slate-200 flex flex-col">
            ...
            <div className="relative z-10 flex items-start justify-between">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  title="Imprimir ou Salvar Notificação em PDF"
          ...
          <div className="p-6 bg-slate-50/80 border-t border-slate-100 flex items-center justify-between gap-3">
            <div className="flex items-center gap-2">
              <button
                onClick={onClose}
                className="px-3.5 py-2.5 rounded-xl text-xs font-bold text-slate-500 hover:text-slate-700 hover:bg-slate-100 transition-colors uppercase tracking-wider"
              >
                Lembrar mais tarde
              </button>
              ...
              <button
                onClick={() => setIsPrintOpen(true)}
                className="px-3.5 py-2.5 rounded-xl text-xs font-bold text-slate-700 bg-white border border-slate-200 hover:bg-slate-100 hover:border-slate-300 transition-colors flex items-center gap-1.5 uppercase tracking-wider shadow-sm"
                title="Imprimir ou Salvar Notificação em PDF"
              >
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-xl text-xs font-black text-white bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 shadow-lg shadow-orange-500/25 flex items-center gap-2 uppercase tracking-wider transition-all hover:scale-[1.02] active:scale-[0.98]"
            >
      ...
      {/* Relatório / Ofício Oficial de Notificação */}
      {isPrintOpen && (
        <PrintableAlertasPendenciasReport
          items={[currentAlert]}
          initialMode="oficio"
          escolaNome={currentAlert.escola_nome}
