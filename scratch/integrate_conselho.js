...
// 2. Add useConfiguracao call
content = content.replace(
    "export const ConselhoClasse: React.FC<ConselhoClasseProps> = ({ escolas, userEmail, isAdmin, currentUser, forcedEtapa, externalSelectedEscolaId, onEscolaChange, isDemoMode }) => {",
...
// 8. Inject warning banner inside form tabs or screens.
// We can find where the forms are and disable the buttons when `isBlocked` is true
// For example, in Acompanhamento Docente form submit button, Ata / Encaminhamentos save button.
