...
export type ViewState = 'DASHBOARD' | 'LISTA_ESCOLAS' | 'DETALHE_ESCOLA' | 'NOVA_VISITA' | 'COORDENADORES' | 'RELATORIOS' | 'INDICADORES' | 'NOTIFICACOES' | 'AUDIT_LOGS' | 'GESTAO_USUARIOS' | 'INSTRUMENTAIS_GESTAO' | 'CONSELHO_CLASSE' | 'CONSELHO_CLASSE_FUNDAMENTAL' | 'CONSELHO_CLASSE_INFANTIL' | 'PERMISSOES' | 'ATIVIDADES_COMPLEMENTARES' | 'GESTAO_ESTUDANTES' | 'MERENDA_ESCOLAR' | 'PLANO_AULA' | 'AULAS_MINISTRADAS' | 'FREQUENCIA' | 'NOTAS' | 'PLANO_CURSO' | 'DIARIO_FUNDAMENTAL' | 'DIARIO_INFANTIL';
